...
exports.NEWS_API = exports.LOCAL_SERVER = exports.HOTEL_API = void 0;
var LOCAL_SERVER = exports.LOCAL_SERVER = 'http://localhost:8000';
var NEWS_API = exports.NEWS_API = 'api/v1/news';
var HOTEL_API = exports.HOTEL_API = 'api/v1/news';
...
},{}],"../js/views/pageView.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var PageContentView = /*#__PURE__*/function (_View) {
  _inherits(PageContentView, _View);
  var _super = _createSuper(PageContentView);
  function PageContentView() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector(".content-container"));
    _defineProperty(_assertThisInitialized(_this), "_swiper", _this._parentElement.querySelectorAll(".swiper"));
    _defineProperty(_assertThisInitialized(_this), "_markup", "");
    return _this;
  }
...
var _default = exports.default = new PageContentView();
},{"./View":"../js/views/View.js"}],"../js/views/navbarView.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var NavbarView = /*#__PURE__*/function (_View) {
  _inherits(NavbarView, _View);
  var _super = _createSuper(NavbarView);
  function NavbarView() {
    var _this;
    _classCallCheck(this, NavbarView);
    _this = _super.call(this);
    _defineProperty(_assertThisInitialized(_this), "_parentElement", document.querySelector('.navbar'));
    _defineProperty(_assertThisInitialized(_this), "_navbarHeight", _this._parentElement.getBoundingClientRect().height);
    _defineProperty(_assertThisInitialized(_this), "_heroSection", document.querySelector('.section-hero'));
    _defineProperty(_assertThisInitialized(_this), "_sectionObserver", new IntersectionObserver(function (entries) {
      _this._stickyNavBar(entries);
    }, {
      root: null,
      // entire viewport
      threshold: 0,
      // When hero is completely out of view
      rootMargin: "-".concat(_this._navbarHeight, "px")
    }));
    _this._sectionObserver.observe(_this._heroSection);
    return _this;
  }
  _createClass(NavbarView, [{
    key: "_stickyNavBar",
    value: function _stickyNavBar(entries) {
...
var _default = exports.default = new NavbarView();
},{"./View":"../js/views/View.js"}],"../../node_modules/swiper/shared/ssr-window.esm.mjs":[function(require,module,exports) {
"use strict";
...
},{"../shared/create-shadow.mjs":"../../node_modules/swiper/shared/create-shadow.mjs","../shared/effect-init.mjs":"../../node_modules/swiper/shared/effect-init.mjs","../shared/effect-target.mjs":"../../node_modules/swiper/shared/effect-target.mjs","../shared/effect-virtual-transition-end.mjs":"../../node_modules/swiper/shared/effect-virtual-transition-end.mjs","../shared/utils.mjs":"../../node_modules/swiper/shared/utils.mjs"}],"../../node_modules/swiper/swiper-bundle.mjs":[function(require,module,exports) {
"use strict";
...
var _swiperCore = require("./shared/swiper-core.mjs");
var _virtual = _interopRequireDefault(require("./modules/virtual.mjs"));
var _keyboard = _interopRequireDefault(require("./modules/keyboard.mjs"));
var _mousewheel = _interopRequireDefault(require("./modules/mousewheel.mjs"));
var _navigation = _interopRequireDefault(require("./modules/navigation.mjs"));
var _pagination = _interopRequireDefault(require("./modules/pagination.mjs"));
var _scrollbar = _interopRequireDefault(require("./modules/scrollbar.mjs"));
var _parallax = _interopRequireDefault(require("./modules/parallax.mjs"));
var _zoom = _interopRequireDefault(require("./modules/zoom.mjs"));
var _controller = _interopRequireDefault(require("./modules/controller.mjs"));
var _a11y = _interopRequireDefault(require("./modules/a11y.mjs"));
var _history = _interopRequireDefault(require("./modules/history.mjs"));
var _hashNavigation = _interopRequireDefault(require("./modules/hash-navigation.mjs"));
var _autoplay = _interopRequireDefault(require("./modules/autoplay.mjs"));
var _thumbs = _interopRequireDefault(require("./modules/thumbs.mjs"));
var _freeMode = _interopRequireDefault(require("./modules/free-mode.mjs"));
var _grid = _interopRequireDefault(require("./modules/grid.mjs"));
var _manipulation = _interopRequireDefault(require("./modules/manipulation.mjs"));
var _effectFade = _interopRequireDefault(require("./modules/effect-fade.mjs"));
var _effectCube = _interopRequireDefault(require("./modules/effect-cube.mjs"));
var _effectFlip = _interopRequireDefault(require("./modules/effect-flip.mjs"));
var _effectCoverflow = _interopRequireDefault(require("./modules/effect-coverflow.mjs"));
var _effectCreative = _interopRequireDefault(require("./modules/effect-creative.mjs"));
var _effectCards = _interopRequireDefault(require("./modules/effect-cards.mjs"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/**
 * Swiper 10.3.1
...
// Swiper Class
const modules = [_virtual.default, _keyboard.default, _mousewheel.default, _navigation.default, _pagination.default, _scrollbar.default, _parallax.default, _zoom.default, _controller.default, _a11y.default, _history.default, _hashNavigation.default, _autoplay.default, _thumbs.default, _freeMode.default, _grid.default, _manipulation.default, _effectFade.default, _effectCube.default, _effectFlip.default, _effectCoverflow.default, _effectCreative.default, _effectCards.default];
_swiperCore.S.use(modules);
},{"./shared/swiper-core.mjs":"../../node_modules/swiper/shared/swiper-core.mjs","./modules/virtual.mjs":"../../node_modules/swiper/modules/virtual.mjs","./modules/keyboard.mjs":"../../node_modules/swiper/modules/keyboard.mjs","./modules/mousewheel.mjs":"../../node_modules/swiper/modules/mousewheel.mjs","./modules/navigation.mjs":"../../node_modules/swiper/modules/navigation.mjs","./modules/pagination.mjs":"../../node_modules/swiper/modules/pagination.mjs","./modules/scrollbar.mjs":"../../node_modules/swiper/modules/scrollbar.mjs","./modules/parallax.mjs":"../../node_modules/swiper/modules/parallax.mjs","./modules/zoom.mjs":"../../node_modules/swiper/modules/zoom.mjs","./modules/controller.mjs":"../../node_modules/swiper/modules/controller.mjs","./modules/a11y.mjs":"../../node_modules/swiper/modules/a11y.mjs","./modules/history.mjs":"../../node_modules/swiper/modules/history.mjs","./modules/hash-navigation.mjs":"../../node_modules/swiper/modules/hash-navigation.mjs","./modules/autoplay.mjs":"../../node_modules/swiper/modules/autoplay.mjs","./modules/thumbs.mjs":"../../node_modules/swiper/modules/thumbs.mjs","./modules/free-mode.mjs":"../../node_modules/swiper/modules/free-mode.mjs","./modules/grid.mjs":"../../node_modules/swiper/modules/grid.mjs","./modules/manipulation.mjs":"../../node_modules/swiper/modules/manipulation.mjs","./modules/effect-fade.mjs":"../../node_modules/swiper/modules/effect-fade.mjs","./modules/effect-cube.mjs":"../../node_modules/swiper/modules/effect-cube.mjs","./modules/effect-flip.mjs":"../../node_modules/swiper/modules/effect-flip.mjs","./modules/effect-coverflow.mjs":"../../node_modules/swiper/modules/effect-coverflow.mjs","./modules/effect-creative.mjs":"../../node_modules/swiper/modules/effect-creative.mjs","./modules/effect-cards.mjs":"../../node_modules/swiper/modules/effect-cards.mjs"}],"../js/views/swiperView.js":[function(require,module,exports) {
"use strict";
...
require("swiper/swiper-bundle.mjs");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } // core version + navigation, pagination modules:
// import "swiper/swiper-bundle.min.mjs";
var SwiperView = /*#__PURE__*/function (_View) {
  _inherits(SwiperView, _View);
  var _super = _createSuper(SwiperView);
  function SwiperView() {
    var _this;
    _classCallCheck(this, SwiperView);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    _defineProperty(_assertThisInitialized(_this), "_swiperExists", true);
    _defineProperty(_assertThisInitialized(_this), "_swiper", void 0);
    return _this;
  }
  _createClass(SwiperView, [{
    key: "checkSwiperExistence",
    value: function checkSwiperExistence(contentContainer) {
    ...
    value: function initializeSwiper() {
      var _this2 = this;
      this._swiper.forEach(function (swiperEl) {
        var swiperWrapper = _this2._findSwiperWrapper(swiperEl);
        var cardCount = _this2._countCardInSwiper(swiperWrapper);
        var swiperDirection = swiperEl.classList[1];
        _this2._handleSwiper(swiperEl, cardCount, swiperDirection);
      });
    }
  }, {
    key: "_findSwiperWrapper",
    value: function _findSwiperWrapper(swiperEl) {
      return swiperEl.querySelector('.swiper-wrapper');
    }
  }, {
    key: "_countCardInSwiper",
    value: function _countCardInSwiper(swiperWrapper) {
      if (!swiperWrapper) return 0;
      var cards = swiperWrapper.querySelectorAll('.card');
      return cards.length;
    }
  }, {
    key: "_handleSwiper",
    value: function _handleSwiper(swiperEl, cardCount, swiperDirection) {
      var initialSlide = swiperDirection === 'right-swiper' ? 0 : cardCount - 1;
    ...
    key: "_renderCard",
    value: function _renderCard(data) {
...
var _default = exports.default = new SwiperView();
},{"./View":"../js/views/View.js","swiper":"../../node_modules/swiper/swiper.mjs","swiper/swiper-bundle.mjs":"../../node_modules/swiper/swiper-bundle.mjs"}],"../js/model.js":[function(require,module,exports) {
"use strict";
      ...
      var _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              shouldParse = _args.length > 1 && _args[1] !== undefined ? _args[1] : false;
              _context.prev = 1;
              _context.next = 4;
              return fetch(url);
            case 4:
            ...
            case 7:
              data = _context.sent;
              return _context.abrupt("return", shouldParse ? JSON.parse(data) : data);
            case 11:
              _context.prev = 11;
...
var _default = exports.default = new Model();
},{}],"../js/controller.js":[function(require,module,exports) {
"use strict";

var _settings = require("./settings");
var _pageView = _interopRequireDefault(require("./views/pageView"));
var _navbarView = _interopRequireDefault(require("./views/navbarView"));
var _swiperView = _interopRequireDefault(require("./views/swiperView"));
...
var Controller = /*#__PURE__*/function () {
  function Controller() {
    ...
    _defineProperty(this, "_loadPage", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _model.default.fetchData("".concat(_this._pageName, ".html"));
          case 2:
    ...
    _defineProperty(this, "_navigate", function () {
      _this._pageName = location.hash.replace('#/', '') || _this._initialPage;
      _this._loadPage(_this._pageName);
    });
    _defineProperty(this, "renderSwiper", function () {
      // 1) Return if swiper container does not exist
      if (!_swiperView.default.checkSwiperExistence(_pageView.default._parentElement)) return;

      // 2) Initialize Swiper
      _swiperView.default.initializeSwiper();
    });
    _defineProperty(this, "_pageMapping", {
  ...
  _createClass(Controller, [{
    key: "renderHomePage",
    value: function () {
      var _renderHomePage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var news;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return _model.default.fetchData("".concat(_settings.LOCAL_SERVER, "/").concat(_settings.NEWS_API), true);
            case 3:
              news = _context2.sent;
...
},{"./settings":"../js/settings.js","./views/pageView":"../js/views/pageView.js","./views/navbarView":"../js/views/navbarView.js","./views/swiperView":"../js/views/swiperView.js","./model":"../js/model.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/controller.090df575.js.map